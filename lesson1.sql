...
Действия:
1. Залить в свою БД данные по продажам (часть таблицы Orders в csv, исходник здесь #### , интересует orders_20190822 )
...
*/
выводы: средний чек в 2017 году увеличился, а число заказов на пользователя снизилось, по сравнению с 2016годом.
